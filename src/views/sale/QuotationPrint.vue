          ...
          <div id="printMe">
              ...
              <v-row>
                <div style="width:100%; display:flex;">
                  <div style="padding:0 20px 10px 20px">
                    <img
                      src="@/assets/AW-Logo-Boonumpar.webp"
                      width="100"
                      height="120"
                    />
                  </div>
                  <div style="padding:10px 0 10px ">
                    <h2 style="font-size:22px">
                      บริษัท บุญนำพา (Boon-Num-Par) จำกัด
                    </h2>
                    <p style="font-size:18px">
                      218 หมู่ 1 ถ. ฝ่ายท่าหนองหัดไท ต.พงษ์ประศาสน์ อ.บางสะพาน
                      รหัสไปรษณีย์ 77140 <br />
                      โทร. 012-345-678, 098-787-6656, 095-234-1231 Fax. 09876543
                      E-mail:SALE@boonnumpar.co.th
                    </p>
                  </div>
                </div>
                <table
                  style="width:100%; border-bottom:white;border-left:white;"
                  border="none"
                  cellspacing="0"
                  cellpadding="0"
                >
                  <thead>
                    <tr
                      style="border-bottom:black;border-left:black;border-right:black;padding:15px 0 -10px;"
                    >
                      <th
                        COLSPAN="10"
                  ...
                  <tbody class="t-body" style="border-bottom:black;">
                    <tr
                      class="tb-header"
                      style="border-bottom:black;border-left:black;"
                    >
                      <td COLSPAN="6" style="width:60%; border-right:black;">
                        <div style="display:flex;">
                          <v-row>
                            ...
                            >
                              เบอร์ติดต่อ:
                              {{ Header.cti_telephone_number }} Email:
                              {{ Header.cti_email }}
                            </v-col>
                          </v-row>
                        </div>
                    ...
                    <tr
                      class="tb-head"
                      align="center"
                      style="border-bottom:black;border-left:black;border-right:black;"
                    >
                    ...
                    <tr
                      v-for="(item, index) in Bodys.packages"
                      :key="item.id"
                      class="tb-data"
                      align="center"
                      style="border-left:black;border-right:black;"
                    >
                    ...
                    <tr
                      v-for="(item, index) in Bodys.promotions"
                      :key="item.id"
                      class="tb-data"
                      align="center"
                      style="border-left:black;border-right:black;"
                    >
                      ...
                      <td COLSPAN="1" v-if="item.promotion_discount != 0">
                  ...
                  <tfoot>
                    <tr
                      align="center"
                      style="border-bottom:black;border-right:black;"
                    >
                      <td
                        COLSPAN="1"
                        class="widthzero"
                        align="start"
                        style="border-bottom:white !important;border-left:white !important;border-right: white;"
                      >
                        หมายเหตุ <br /><br /><br /><br />
                      </td>
                      <td
                        COLSPAN="5"
                        align="start"
                        style="border-bottom:white !important;border-left:white !important;"
                      >
                      ...
                      <td COLSPAN="2" align="center">
                        <div>รวม</div>
                        <div v-if="Footer.discount_percent">
                          ส่วนลด ({{ Footer.discount_percent }})
                        </div>
            ...
            <v-col>
              <v-row>
                ...
                ธ.กสิกรไทย สาขาโลตัส รามอินทรา 109 เลขที่บัญชี 069 - 3 - 51962 -
                6
                <br />
            ...
            <v-row>
              ...
              <v-col class="text-start" md="1" style="text-align:left"> </v-col>
              <v-col class="text-end" md="1" style="text-align:right"> </v-col>
              ...
              <v-col class="text-center" md="2" style="text-align:center">
                ณัฐกานต์ หทัยราษฎร์
              </v-col>
...
export default {
  ...
  methods: {
    async loadDatas() {
      ...
      this.ID_Quotation_show = {
        quotation_code: this.$store.getters["Newpersonal_BNP_ID"].BNP_ID
      };
