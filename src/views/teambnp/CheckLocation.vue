          ...
          >
            ...
            <template v-slot:item="{ item }">
              <tr>
                ...
                <td align="center">
                    <button class="button-left"  :class="{'active' : isActive==1}" @click='test(1)' >ผ่าน</button>
                    <button class="button-right" :class="{'active' : isActive==2}" @click='test(2)'>ไม่ผ่าน</button>
                </td>
                <td>
                <v-row>
