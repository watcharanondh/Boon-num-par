  ...
  <v-container style="background:#E5E5E5;color:white;height:100%">
    ...
    <v-row>
      <v-col lg="12" md="12" sm="12" cols="12">
        ...
        <v-card>
          <v-data-table
            :headers="headers_table_promotion"
            :items="table_promotion"
            :items-per-page="10"
            class="elevation-1"
          >
            <!-- table top section -->
...
export default {
  ...
  data: () => ({
    table_promotion: [],
    headers_table_promotion: [
      { text: "รหัสโปรโมชั่น", value: "id", sortable: false, align: "start", color: "black"},
      { text: "ชื่อโปรโมชั่น", value: "name", sortable: false, align: "start" },
      { text: "ราคา", value: "customer_tax_invoices", sortable: false, align: "start"},
