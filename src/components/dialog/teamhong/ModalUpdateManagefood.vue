    ...
    <template v-slot:default="dialogSelectStatus">
      <v-card>
        <v-card-title>
          <v-row>
            <v-col>
              <div class="update-head-title">จัดทีม</div>
            </v-col>
          </v-row>
        </v-card-title>
        <v-card-title>
          <v-row>
            <v-col>
              <div class="update-sub-title">กิจกรรม</div>
              <div class="update-sub-activity">จัดไลน์อาหาร</div>
            </v-col>
          </v-row>
        </v-card-title>
        <v-card-title>
          <v-row>
            <v-col>
              <div class="update-sub-title">เลือกทีม</div>
            </v-col>
          </v-row>
        </v-card-title>
        <v-card-text>
        ...
        <v-card-title>
          <v-row>
            <v-col>
              <div class="update-sub-title">เลือกคนรถ</div>
            </v-col>
          </v-row>
        </v-card-title>
        <v-card-text>
